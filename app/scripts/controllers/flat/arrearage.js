...
.controller('ArrearageCtrl', ['$scope', 'AppConfig','$rootScope','StudentService','FlatService','$filter','PublicService',
function($scope,AppConfig,$rootScope,StudentService,FlatService,$filter,PublicService) {
