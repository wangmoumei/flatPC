...
.controller('RuleSettingCtrl', ['$scope','$rootScope','AppConfig',function($scope,$rootScope,AppConfig) {
        //存储列表头到frame.html中
    $scope.menus = [
        '公寓管理','宿舍考评','违章设置'
    ];
    ...
    var schoolcode=AppConfig.schoolCode;
    var a = document.createElement('a');
    a.href = "http://baidu.com?token="+token+"&schoolcode="+schoolcode;    
    a.target="page-frame";
    a.click();
